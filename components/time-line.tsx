            ...
            <div className="-my-6">
                {dataAboutPage.map((data) => (
                    <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                        ...
                        group-last:before:hidden before:absolute before:left-2 sm:before:left-0
                        ...
                        after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600
                        ...
                        justify-center text-xs font-semibold uppdercase w-20 h-6 sm:mb-0 text-emerald-600 bg-emerald-100 rounded-full">{data.date}</time>
